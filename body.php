				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							<div class="shop-img">
								<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Culinary_fruits_front_view.jpg/500px-Culinary_fruits_front_view.jpg" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUH07GX7Jp6bkSWmMMxVw65UqsYEIvyIJplQ&usqp=CAU" alt="">
							</div>
							<div class="shop-body">
								<h3>Herb<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							<div class="shop-img">
								<img src="https://medlineplus.gov/images/HerbalMedicine_share.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Herb Products<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Fruit</a></li>
									<li><a data-toggle="tab" href="#tab1">Herb</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Fresh fruit deal this week</h2>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 82 AND 92";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
